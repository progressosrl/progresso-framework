...
class ImageResize
{
    ...
    public $quality_truecolor = \true;
    public $gamma_correct = \true;
    public $interlace = 1;
    public $source_type;
    ...
    {
        $string_temp = \tempnam(\sys_get_temp_dir(), '');
     ...
     * @return static
     */
    public function gamma($enable = \true)
    {
